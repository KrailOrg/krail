...
public interface ViewConfig {
    ...
    /**
     * In most layouts there is one component which takes up all the remaining space. This is usually achieved by a
     * call
    ...
    /**
     * Add a split (in user interface terms, this is either a {@link VerticalSplitPanel} or {@link
    ...
    /**
     * The Unit to use in setting component widths and heights, using the same value for each. If not set explicitly,
     * it
