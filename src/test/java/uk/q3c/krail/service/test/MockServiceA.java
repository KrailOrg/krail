...
public class MockServiceA extends MockService {
    ...
    @Inject
    protected MockServiceA(Translate translate, MessageBus globalBusProvider, RelatedServiceExecutor servicesExecutor, SerializationSupport serializationSupport) {
