...
public class MockServiceD extends MockService {
    ...
    @Inject
    protected MockServiceD(Translate translate, MessageBus globalBusProvider, RelatedServiceExecutor servicesExecutor, SerializationSupport serializationSupport) {
