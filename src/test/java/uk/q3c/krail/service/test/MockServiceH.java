...
public class MockServiceH extends MockService {
    ...
    @Inject
    protected MockServiceH(Translate translate, MessageBus globalBusProvider, RelatedServiceExecutor servicesExecutor, SerializationSupport serializationSupport) {
