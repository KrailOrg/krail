...
public class MockServiceE extends MockService {
    ...
    @Inject
    protected MockServiceE(Translate translate, MessageBus globalBusProvider, RelatedServiceExecutor servicesExecutor, SerializationSupport serializationSupport) {
