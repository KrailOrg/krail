...
public class MockServiceF extends MockService {
    ...
    @Inject
    protected MockServiceF(Translate translate, MessageBus globalBusProvider, RelatedServiceExecutor servicesExecutor, SerializationSupport serializationSupport) {
