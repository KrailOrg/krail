...
@GuiceContext({TestKrailI18NModule.class, SerializationSupportModule.class, ServletEnvironmentModule.class, EventBusModule.class, UtilModule.class, UtilsModule.class, TestOptionModule.class, InMemoryModule.class, VaadinEventBusModule.class, UIScopeModule.class, VaadinSessionScopeModule.class,})
