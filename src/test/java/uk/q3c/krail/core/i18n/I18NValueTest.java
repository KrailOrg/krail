...
@GuiceContext({TestKrailI18NModule.class, EventBusModule.class, TestOptionModule.class, TestPersistenceModuleVaadin.class, VaadinEventBusModule.class, UIScopeModule.class, VaadinSessionScopeModule
