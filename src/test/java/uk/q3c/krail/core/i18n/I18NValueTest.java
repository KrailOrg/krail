...
@GuiceContext({TestKrailI18NModule.class, EventBusModule.class, TestOptionModule.class, InMemoryModule.class, VaadinEventBusModule.class, UIScopeModule.class, VaadinSessionScopeModule
