...
@GuiceContext({UIScopeModule.class, VaadinSessionScopeModule.class, TestI18NModule.class, TestOptionModule.class, EventBusModule.class})
public class DefaultUserNavigationMenuTest {
    ...
    public void setMaxDepth() {
        ...
        int result = userNavigationMenu.getOption()
                                       .get(-1, DefaultUserNavigationMenu.optionKeyMaximumDepth);
