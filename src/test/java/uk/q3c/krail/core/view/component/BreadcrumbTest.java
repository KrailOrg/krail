...
@GuiceContext({TestOptionModule.class, InMemoryModule.class, VaadinSessionScopeModule.class, VaadinEventBusModule.class,
        TestUIScopeModule.class, UtilModule.class, UtilsModule.class, UserModule.class, TestKrailI18NModule2.class, DefaultShiroModule.class, SerializationSupportModule.class, ServletEnvironmentModule.class})
