...
@GuiceContext({VaadinSessionScopeModule.class, EventBusModule.class, TestOptionModule.class, InMemoryModule.class, VaadinEventBusModule.class, UIScopeModule.class, TestI18NModule
