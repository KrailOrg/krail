...
@GuiceContext({VaadinSessionScopeModule.class, EventBusModule.class, TestOptionModule.class, TestPersistenceModuleVaadin.class, VaadinEventBusModule.class, UIScopeModule.class, TestI18NModule
