...
@GuiceContext({AnnotationsModule1.class, AnnotationsModule2.class, TestPersistenceModuleVaadin.class, TestVaadinI18NModule.class, VaadinSessionScopeModule.class,
