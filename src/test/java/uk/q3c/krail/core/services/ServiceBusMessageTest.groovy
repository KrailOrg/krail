...
class ServiceBusMessageTest extends Specification {
    ...
    def "create"() {
        ...
        given:
        ServiceBusMessage msg = new ServiceBusMessage(serviceA, DEPENDENCY_STOPPED, FAILED_TO_START)

        expect:
        msg.getFromState() == DEPENDENCY_STOPPED
        msg.getToState() == FAILED_TO_START
