...
/**
 * Default and supported locales set with Locale Strings
 */
...
public class I18NModuleTest2 {
    ...
    protected AbstractModule moduleProvider() {
        //duplicates Locale.ITALY
        return new I18NModule().defaultLocale("it_IT")
                               .supportedLocales("it_IT", "de_DE");
    }
}