...
public class DefaultServiceModel implements ServiceModel {
    ...
    @Override
    public ServiceInstanceGraph getInstanceGraph() {
        return instanceGraph;
    }

    @Override
    public ServiceClassGraph getClassGraph() {
        return classGraph;
    }
    ...
    @Override
    public List<Service> findInstanceDependencies(Service service, ServiceGraph.Selection selection) {
        return instanceGraph.findDependencies(service, selection);
    }

    @Override
    public synchronized void stopAllServices() {
        log.info("Stopping all service");
