...
/**
 * Copied from the original Shiro implementation
 *
...
public class DefaultAnnotationResolver implements AnnotationResolver {
    ...
    /**
     * Returns {@code methodInvocation.}{@link org.apache.shiro.aop.MethodInvocation#getMethod() getMethod()}.{@link Method#getAnnotation(Class)
     * getAnnotation(clazz)}.
     *
     * @param mi
     *         the intercepted method to be invoked.
     * @param clazz
     *         the annotation class to use to find an annotation instance on the method.
     *
    ...
    public <A extends Annotation> A getAnnotation(MethodInvocation mi, Class<A> clazz) {
        ...
        A annotation = m.getAnnotation(clazz);
        return annotation == null ? mi.getThis()
                                      .getClass()
                                      .getAnnotation(clazz) : annotation;
    }
}
