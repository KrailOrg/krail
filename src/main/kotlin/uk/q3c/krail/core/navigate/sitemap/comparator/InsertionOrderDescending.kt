...
/**
 * Comparator which can be used to sort SitemapNode by insertion order, based on [MasterSitemapNode.id]
 */
class InsertionOrderDescending : UserSitemapNodeComparator {

    override fun nameKey(): I18NKey {
        return LabelKey.Insertion_Order_Descending
    }
