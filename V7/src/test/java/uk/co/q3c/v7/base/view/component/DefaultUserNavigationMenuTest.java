...
public class DefaultUserNavigationMenuTest {
	...
	public void localeChange() {
		...
		// then
		List<String> captions = menuCaptions(null);
		assertThat(captions).containsOnly("Öffentlichkeit", "Privat");
	...
	public void userSelection() {
		...
		// when
		viewA11.getCommand().menuSelected(viewA11);
		// then
	...
	public void sorted() {
		...
		assertThat(captions).containsExactly("Privat", "Öffentlichkeit");
