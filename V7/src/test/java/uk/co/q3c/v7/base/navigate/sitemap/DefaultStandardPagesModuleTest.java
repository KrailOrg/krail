...
@GuiceContext({ StandardPagesModule.class, UIScopeModule.class, StandardViewModule.class, ShiroVaadinModule.class,
		I18NModule.class, SitemapServiceModule.class, UserModule.class, ApplicationConfigurationModule.class,
