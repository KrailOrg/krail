...
import uk.q3c.krail.core.navigate.StandardPageMappingReader;
...
public class DeconstructPageMappingTest {
    ...
    public void line_empty_standardpagekey() {
        ...
        // then
        assertThat(pr).isNull();
        assertThat(dpm.getSyntaxErrors()).containsOnly(StandardPageMappingReader.emptyStandardPageKey + " at line " +
                lineNumber);
    }
}
