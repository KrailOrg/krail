...
public interface V7View {
	 ...
	 * 
	 * This method is always called before the view is shown on screen (but
	 * <b>before</b> being attached to the ui).
	 ...
	 * @return false to cancel the navigation, true to proceed
	 */
	 ...
	 * 
	 * This method is always called before the view is shown on screen (but
	 * <b>after</b> being attached to the ui).
	 * {@link ViewChangeEvent#getParameters() event.getParameters()} may contain
	 * extra parameters relevant to the view.
	 * 
	 * @param event
