 ...
 * {@link I18NKeys#getValue(Locale)}, this class simply provides a slightly neater syntax, and a method for expanding a
...
public class I18NValue {
	...
	public String message(Locale locale, I18NKeys<?> key, Object... arguments) {
	...
	public String message(I18NKeys<?> key, Object... arguments) {
		return message(currentLocale.getLocale(), key, arguments);
	}

	public String message(I18NKeys<?> key) {
