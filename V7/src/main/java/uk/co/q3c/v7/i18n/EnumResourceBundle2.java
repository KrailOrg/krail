...
public abstract class EnumResourceBundle2<E extends I18NKey2> extends ResourceBundle {
    ...
    public String getValue(E key) {
        ...
        @SuppressWarnings("unchecked") EnumResourceBundle2<E> enumparent = (EnumResourceBundle2<E>) parent;
