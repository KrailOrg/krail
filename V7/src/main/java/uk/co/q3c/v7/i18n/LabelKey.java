...
public enum LabelKey implements I18NKey<Labels> {
	_nullkey_, Application_Configuration_Service, Authentication, Authorisation, Cancel, First_Name, Guest, Invalid_Page, Last_Name, Log_In, Log_Out, No, Ok, Small, Yes, ;
