 ...
 */
package uk.q3c.krail.base.navigate.sitemap.comparator;
 ...
 */
public class AlphabeticAscending implements Comparator<UserSitemapNode>, UserSitemapSorter {

    @Override
    public int compare(UserSitemapNode o1, UserSitemapNode o2) {
        return o1.getCollationKey()
                 .compareTo(o2.getCollationKey());
    }
