...
/**
 * When an application is built on V7, or a library is added, it is possible that a configuration value from another
 * part of V7 may need to be overridden with a new value. This class, combined with {@link InheritingConfiguration}
