...
public abstract class AnnotationSitemapModule extends AbstractModule {
     ...
     * <p/>
     * addEntry("uk.q3c.krail.base.view",LabelKey.Home);
     * <p/>
     * which would scan all packages beginning with 'uk.q3c.krail.base.view', and the LabelKey class would be used to
