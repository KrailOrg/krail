...
public interface FileSitemapLoader extends SitemapLoader {
    ...
    static String VIEW_DOES_NOT_IMPLEMENT_KRAILVIEW = "{0} is not a valid KrailView class";
    static String VIEW_NOT_FOUND_IN_SPECIFIED_PACKAGES = "View class {0} has not been defined in any of the " +
            "specified" + " packages";
    ...
    static String LINE_FORMAT_MISSING_START_CHAR = "Line must start with '-', '+', " + "'~' or '#' depending on which" +
